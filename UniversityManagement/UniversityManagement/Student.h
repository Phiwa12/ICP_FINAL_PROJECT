...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(335, 72);
			...
			// enroll
			// 
			this->enroll->Location = System::Drawing::Point(140, 185);
			...
			// payfees
			// 
			this->payfees->Location = System::Drawing::Point(398, 185);
			...
			// profile
			// 
			this->profile->Location = System::Drawing::Point(140, 284);
			...
			// viewgrades
			// 
			this->viewgrades->Location = System::Drawing::Point(601, 185);
			...
			// logout
			// 
			this->logout->Location = System::Drawing::Point(398, 284);
			...
			// transcript
			// 
			this->transcript->Location = System::Drawing::Point(601, 284);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	ViewSchedule^ schedule = gcnew ViewSchedule(id);
	schedule->Show();
}
