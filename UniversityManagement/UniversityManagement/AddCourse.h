...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->semester->Location = System::Drawing::Point(312, 168);
			...
			this->label9->Location = System::Drawing::Point(137, 176);
			...
			// submit
			// 
			this->submit->Location = System::Drawing::Point(291, 505);
			...
			// facID
			// 
			this->facID->Location = System::Drawing::Point(312, 218);
			...
			// totalCredits
			// 
			this->totalCredits->Location = System::Drawing::Point(312, 127);
			...
			// courseName
			// 
			this->courseName->Location = System::Drawing::Point(312, 95);
			...
			this->label3->Location = System::Drawing::Point(136, 134);
			...
			this->label1->Location = System::Drawing::Point(229, 54);
			...
			this->label4->Location = System::Drawing::Point(137, 221);
			...
			// maxEnrollment
			// 
			this->maxEnrollment->Location = System::Drawing::Point(312, 262);
			...
			this->label6->Location = System::Drawing::Point(137, 305);
			...
			this->availability->Location = System::Drawing::Point(312, 302);
			...
			this->prerequisites->Location = System::Drawing::Point(140, 337);
			...
			// 
			this->selectedPrerequisites->Location = System::Drawing::Point(429, 337);
			...
			// 
			this->addPrerequisiteButton->Location = System::Drawing::Point(282, 337);
			...
			// 
			this->removePrerequisiteButton->Location = System::Drawing::Point(282, 409);
...
#pragma endregion
	private: System::Void AddCourse_Load(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			prerequisits->Items->Clear();
			for each (DataRow ^ row in sqlDt->Rows) {
				prerequisits->Items->Add(row["CourseID"]->ToString() + " - " + row["CourseName"]->ToString());
			}
	...
	private: System::Void addPrerequisiteButton_Click(System::Object^ sender, System::EventArgs^ e) {
		if (prerequisits->SelectedItem != nullptr) {
			selectedPrerequisites->Items->Add(prerequisits->SelectedItem);
			prerequisits->Items->Remove(prerequisits->SelectedItem);
		}
	}
	...
	if (selectedPrerequisites->SelectedItem != nullptr) {
		prerequisits->Items->Add(selectedPrerequisites->SelectedItem);
