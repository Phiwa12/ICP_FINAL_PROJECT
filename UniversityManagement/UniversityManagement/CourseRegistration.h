...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(439, 167);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(322, 167);
			...
			this->availablecourses->Location = System::Drawing::Point(12, 148);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(327, 100);
			...
			// courseid
			// 
			this->courseid->Location = System::Drawing::Point(491, 99);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		sqlCmd->CommandText = "INSERT INTO Enrollments (StudentID, CourseID, EnrollmentDate) VALUES (@StudentID, @CourseID, NOW());";
		sqlCmd->Parameters->AddWithValue("@StudentID", userId);
		sqlCmd->Parameters->AddWithValue("@CourseID", Convert::ToInt32(selectedCourseID));
