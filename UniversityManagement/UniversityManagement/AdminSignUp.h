...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(204, 167);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(252, 332);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(422, 332);
			...
			this->label5->Location = System::Drawing::Point(204, 241);
			...
			this->label4->Location = System::Drawing::Point(204, 204);
			...
			this->label3->Location = System::Drawing::Point(204, 124);
			...
			this->label2->Location = System::Drawing::Point(200, 85);
			...
			this->label1->Location = System::Drawing::Point(282, 44);
		...
		void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			if (isValid) {
				try {
					...
					sqlCmd->Parameters->AddWithValue("@passwordA", passwordA);
