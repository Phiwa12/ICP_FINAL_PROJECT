...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// txtStudentID
			// 
			this->txtStudentID->Location = System::Drawing::Point(123, 40);
			...
			// txtPaidAmount
			// 
			this->txtPaidAmount->Location = System::Drawing::Point(123, 80);
			...
			// btnUpdatePayment
			// 
			this->btnUpdatePayment->Location = System::Drawing::Point(123, 120);
			...
			this->lblPaidAmount->Size = System::Drawing::Size(70, 13);
