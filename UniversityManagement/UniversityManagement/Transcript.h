...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(145, 21);
			this->label1->TabIndex = 18;
			this->label1->Text = L"View Transcript";
			// 
			// transcriptBox
			// 
			this->transcriptBox->Location = System::Drawing::Point(159, 129);
			this->transcriptBox->Name = L"transcriptBox";
			this->transcriptBox->Size = System::Drawing::Size(491, 311);
			...
			this->ClientSize = System::Drawing::Size(771, 472);
